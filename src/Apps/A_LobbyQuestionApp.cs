namespace AdventOfCode.Apps
{
    ...
    public class A_LobbyQuestionApp : IApp<int[,], long>
    {
        ...
        public ISolver<int[,], long> solver => new A_LobbyQuestionSolver();
        ...
        public A_LobbyQuestionApp(IInputReader reader, IOutputWriter writer)
        {
